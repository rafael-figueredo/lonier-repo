...
export default function ServicesMap(props) {
  ...
  function InfoNote(props) {
    ...
    return (
      <div
        ...
        } absolute bg-white z-20 h-auto flex items-start shadow-lg ${
  ...
  const skinCareLogo = (
    ...
    >
      <p className="mb-3 mt-auto">Usamos a Linha de Cuidados Rezâge</p>
      <img
        src="/svg/rezage-logo.svg"
        style={{ width: "60px", height: "60px" }}
        alt="Usamos a Linha de Cuidados Rezâge"
      />
    </div>
  );
